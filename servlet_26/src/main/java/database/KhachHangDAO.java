...
public class KhachHangDAO implements DAOInterface<KhachHang> {
	...
	public ArrayList<KhachHang> selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				Timestamp thoiGianHieuLuc = rs.getTimestamp("thoigianhieulucmaxacthuc");
				boolean trangThai = rs.getBoolean("trangthaixacthuc");
				String urlAnh = rs.getString("duongdananh");
	...
	public KhachHang selectByUsernameAndPassword(KhachHang khachHang) {
		KhachHang ketQua = null;
		try {
			Connection con = JDBCUtil.getConnection();
	...
	public int updateVerifyInformation(KhachHang t) {
		...
		try {
			...
			st.setTimestamp(2, t.getThoiGianHieuLuc());
			st.setBoolean(3, t.isTrangThai());
